...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb){
    await Firebase.initializeApp(options: const FirebaseOptions(
        apiKey: "AIzaSyBNqx7--NHnpopGDfnHCKbHb2LGv737TBw",
        authDomain: "neara-app.firebaseapp.com",
        projectId: "neara-app",
        storageBucket: "neara-app.firebasestorage.app",
        messagingSenderId: "691319123840",
        appId: "1:691319123840:web:7a5b9d57288c3a510e5b65"
    ));
  } else if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyDpqxWPGAdBvwCcmeGbUGSJ5M0_WUeMiNI",
        appId: "1:691319123840:android:31fc0c1a2bf09f640e5b65",
        messagingSenderId: "691319123840",
        projectId: "neara-app",
      ),
    );
